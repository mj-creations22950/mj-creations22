...
const Admin = () => {
  ...
  const stats = [
    ...
    { label: 'Chiffre affaires', value: '42,580 EUR', change: '+18%', icon: DollarSign, color: 'from-green-500 to-teal-600' },
  ...
  const recentOrders = [
    { id: 'CMD-048', client: 'Sophie Martin', service: 'Plomberie', amount: '280 EUR', status: 'En cours', date: '2025-01-20' },
    { id: 'CMD-047', client: 'Jean Dupont', service: 'Chauffage', amount: '1200 EUR', status: 'Termine', date: '2025-01-19' },
    { id: 'CMD-046', client: 'Marie Leblanc', service: 'Electricite', amount: '850 EUR', status: 'En cours', date: '2025-01-18' },
    { id: 'CMD-045', client: 'Pierre Rousseau', service: 'VMC', amount: '2800 EUR', status: 'Planifie', date: '2025-01-17' }
  ];

  const clients = [
    { id: 1, name: 'Sophie Martin', email: 'sophie.m@email.com', orders: 5, total: '3,280 EUR', status: 'Actif' },
    { id: 2, name: 'Jean Dupont', email: 'jean.d@email.com', orders: 3, total: '4,500 EUR', status: 'Actif' },
    { id: 3, name: 'Marie Leblanc', email: 'marie.l@email.com', orders: 7, total: '8,200 EUR', status: 'VIP' }
  ];

  const upcomingAppointments = [
    { id: 1, client: 'Sophie Martin', service: 'Installation chaudiere', date: '2025-01-25', time: '14:00' },
    { id: 2, client: 'Jean Dupont', service: 'Reparation fuite', date: '2025-01-26', time: '10:00' },
    { id: 3, client: 'Marie Leblanc', service: 'Diagnostic electrique', date: '2025-01-27', time: '09:00' }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-lg opacity-90">Tableau de bord MJ Creations</p>
            </div>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
            ...
            <TabsContent value="dashboard" className="space-y-8">
              ...
              <div className="grid lg:grid-cols-2 gap-8">
                <Card className="border-none shadow-xl">
                  <CardHeader>
                    <CardTitle className="text-xl">Commandes recentes</CardTitle>
                  </CardHeader>
                  <CardContent>
                ...
                <Card className="border-none shadow-xl">
                  <CardHeader>
                    <CardTitle className="text-xl">Rendez-vous a venir</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-3">
            ...
            <TabsContent value="quotes">
              <Card className="border-none shadow-xl">
                ...
                <CardContent>
                  <p className="text-gray-600">Liste des devis en attente et valides...</p>
                </CardContent>
              </Card>
            </TabsContent>
            ...
            <TabsContent value="services">
              <Card className="border-none shadow-xl">
                ...
                <CardContent>
                  <p className="text-gray-600">Gerer les prestations du catalogue...</p>
                </CardContent>
              </Card>
            </TabsContent>
            ...
            <TabsContent value="settings">
              <Card className="border-none shadow-xl">
                <CardHeader>
                  <CardTitle className="text-2xl">Parametres Generaux</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600">Configuration de application...</p>
                </CardContent>
              </Card>
            </TabsContent>
          </Tabs>
